        ...
        <div className='container'>
                ...
                <div className="col">
                    <div className="about-left">
                        <div className="about-thumb">
                            <img src="/historique/hommePaint.jpg" alt="" style={{ width: '100%', height: '550px'}} />
                        </div>
                    </div>
                </div>
            ...
            <div className="row justify-content-center row-cols-xl-2 row-cols-1 align-items-center">
                ...
                <div className="col">
                    <div className="about-left">
                        <div className="about-thumb">
                            <img src="/historique/ex1.jpg" alt="" style={{ width: '100%', height: '600px'}}/>
                        </div>
                        <div className="abs-thumb">
                            <img src="/historique/ex2.jpg" alt="" style={{ width: '300px', height: '300px'}}/>
                        </div>
